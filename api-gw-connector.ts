import { BaseNetworkInterface, RequestAndOptions, ResponseAndOptions, printRequest } from "apollo-client/transport/networkInterface";
...
import { Request as RequestMyApollo, HTTPNetworkInterface } from "apollo-client/transport/networkInterface";
...
export class AwsApiGwNetworkInterface extends BaseNetworkInterface {
  ...
  public fetchFromAwsApiGw({
    ...
    return this.awsApiGatewayClient.graphqlPost(
      {},
